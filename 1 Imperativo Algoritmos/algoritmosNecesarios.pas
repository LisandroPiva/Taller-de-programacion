...
procedure entreCodigos(a:arbol; code1,code2: integer; var cant: integer);
begin
  if(a <> nil)then begin
    if(code1 > a^.dato.codigo)then begin
      if(code1 < a^.dato.codigo)then begin
        cant:= cant + a^.dato.cantProductos;
        entreCodigos(a^.HI, code1, code2, cant);
        entreCodigos(a^.HD, code1, code2, cant)
      end
      else
        entreCodigos(a^.HI, code1, code2, cant);
    end
